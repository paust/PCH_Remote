...
class TelnetInputStream extends PushbackInputStream implements TelnetConstants {
			...
			if (inTelnetState == NOP) {
				if (c == IAC) {
					...
					case LF:
						...
						break;
					case CR:
						ioHandler.CarriageReturn();
						break;
					case BS:
						ioHandler.BackSpace();
						break;
					case HT:
						ioHandler.HorizontalTab();
						break;
					case BEL:
						ioHandler.Bell();
						break;
				...
				case SB:
					ioHandler.OtherCommands(SB);
					break;
				// Indicates that what follows is
				// subnegotiation of the indicated
				// option.
				case SE:
					ioHandler.OtherCommands(SE);
					break;
				// End of subnegotiation parameters.
				case DM:
					ioHandler.OtherCommands(DM);
					break;
				// The data stream portion of a Synch.
				case BRK:
					ioHandler.OtherCommands(BRK);
					break;
				// NVT character BRK.
				case IP:
					ioHandler.OtherCommands(IP);
					break;
				// The function Interrupt Process.
				case AO:
					ioHandler.OtherCommands(AO);
					break;
				// The function Abort Output.
				case AYT:
					ioHandler.OtherCommands(AYT);
					break;
				// The function Are You There.
				case EC:
					ioHandler.OtherCommands(EC);
					break;
				// The function Erase Character.
				case EL:
					ioHandler.OtherCommands(EL);
					break;
				// The function Erase Line.
				case GA:
					ioHandler.OtherCommands(GA);
					break;
				// The Go Ahead signal.
				...
				case WILL:
					...
					if (ioHandler.isWantedOption(c))
						...
						ioOut.sendcmd((byte) DONT, (byte) c);
					break;
				case DO:
					inTelnetState = NOP;
					TelnetOptions.toString(c);
					if (ioHandler.isWantedOption(c))
						...
						//ioOut.sendcmd((byte) WONT, (byte) c);
					ioOut.sendcmd((byte) DONT, (byte) c);
					break;
				}
			}
